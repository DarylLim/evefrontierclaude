    ...
    <div className="min-h-screen bg-ghost-bg text-gray-100 p-4 max-w-md mx-auto">
      ...
      {playerContext ? (
        <>
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            <div className="bg-ghost-surface rounded-lg p-4 border border-ghost-border">
              <FuelGauge
                pct={playerContext.fuelPct}
                unitsRemaining={playerContext.fuelUnitsRemaining}
                maxCapacity={playerContext.fuelMaxCapacity}
              />
            </div>
            <div className="bg-ghost-surface rounded-lg p-4 border border-ghost-border">
        ...
        <div className="space-y-4 py-2">
          {/* Skeleton: Fuel + Threat row */}
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-ghost-surface rounded-lg p-4 border border-ghost-border animate-pulse">
              <div className="flex justify-between mb-2">
                <div className="h-3 w-10 bg-ghost-border rounded" />
                <div className="h-3 w-8 bg-ghost-border rounded" />
              </div>
              <div className="h-2 bg-ghost-border rounded-full" />
              <div className="h-3 w-24 bg-ghost-border rounded mt-2 mx-auto" />
            </div>
            <div className="bg-ghost-surface rounded-lg p-4 border border-ghost-border animate-pulse flex flex-col items-center">
              <div className="w-12 h-12 rounded-full border-2 border-ghost-border" />
              <div className="h-3 w-14 bg-ghost-border rounded mt-2" />
            </div>
          </div>
          {/* Skeleton: Ship stats */}
          <div className="bg-ghost-surface rounded-lg p-4 border border-ghost-border animate-pulse space-y-3">
            <div className="flex justify-between">
              <div className="h-3 w-12 bg-ghost-border rounded" />
              <div className="h-3 w-20 bg-ghost-border rounded" />
            </div>
            <div className="flex justify-between">
              <div className="h-3 w-16 bg-ghost-border rounded" />
              <div className="h-3 w-6 bg-ghost-border rounded" />
            </div>
          </div>
          {/* Skeleton: Alerts */}
          <div className="bg-ghost-surface rounded-lg p-4 border border-ghost-border animate-pulse space-y-2">
            <div className="h-3 w-12 bg-ghost-border rounded" />
            <div className="h-8 bg-ghost-border rounded" />
            <div className="h-8 bg-ghost-border rounded" />
          </div>
        </div>
      )}
      ...
      <div className="mt-4 border border-ghost-border rounded-lg overflow-hidden">
        <button
          ...
          className="w-full flex items-center justify-between px-4 py-2 text-xs text-gray-500 bg-ghost-surface hover:text-gray-300 min-h-[44px]"
        >
